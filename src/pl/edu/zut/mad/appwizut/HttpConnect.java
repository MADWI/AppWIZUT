...
public class HttpConnect {
    ...
    public HttpConnect(int timeout, String adres) {
        ...
        try {
            ...
            Log.e(TAG,e.toString()+"uri syntax w konstruktorze");
            e.printStackTrace();
        }
    }
    ...
    private boolean executeHttpGet() {
        ...
        try {
            ...
            try {
                ...
                //zmienilem z IOExcept na zwykle zeby lapalo nullpointer
                //czemu to nie działa?
                StringWriter errors = new StringWriter();
                e1.printStackTrace(new PrintWriter(errors));

                Log.e(TAG, "Exception 1 (executeHttpGet) " + e1.toString()+errors.toString());
                return false;
            }
            if (in != null) {
                try {
    ...
    public static boolean isOnline(Context ctx) {
        ...
        if (ni != null && ni.isAvailable() && ni.isConnected()) {
            ...
            Toast.makeText(ctx, "Brak połączenia z internetem",
